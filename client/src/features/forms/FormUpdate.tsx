...
const FormUpdate = () => {
    ...
    const form = useForm<z.infer<typeof FormSchema>>() as UseFormReturn<z.infer<typeof FormSchema>> & { control: Control };
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-4/5 space-y-3 md:space-y-6">
                <Typography as={'h2'} className={'text-2xl'}>Mise à jour des données</Typography>
                <FormField
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="*********" type="current-password" {...field} />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea placeholder="Parlez-nous un peu de vous..." {...field} />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    )}
                />
                <Button variant="secondary" type="submit" className="w-full md:w-1/2" asChild={true}>
                    <Link to={'/profil'}>
